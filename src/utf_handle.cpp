...
UTFCoverter::UTFCoverter(){
	printf("UTFCoverter Constructor was Called!\n");
}

UTFCoverter::~UTFCoverter(){
	printf("UTFCoverter Destructor was Called!\n");
};

char UTFCoverter::cp866_upper_char(char cp866){
	//(0x80)-(0x9F) - А-Я
	//(0xA0)-(0xAF) - а-п
	//(0xE0)-(0xEF) - р-я
...
char UTFCoverter::cp866_lower_char(char cp866){
	//(0x80)-(0x9F) - А-Я
	//(0xA0)-(0xAF) - а-п
	//(0xE0)-(0xEF) - р-я
...
int UTFCoverter::conv_utf_w1251(const char* utf8, char* windows1251, size_t n){
	int i = 0;
	int j = 0;
...
int UTFCoverter::cp866_win1251(const char* cp866, char* windows1251, size_t n){
	//(0x80)-(0xAF)+0x40
	//(0xE0)-(0xEF)+0x10
	int i = 0;
...
int UTFCoverter::ucs16_win1251(const char* ucs, char* windows1251, size_t n){
	int i = 0;
	int j = 0;
